...
if (taskCount === 0) {
  const defaultTasks: InsertTask[] = [
    ...
    { title: "Confirm sponsorship — Bianca Shaw",     category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 16 },
    { title: "Confirm sponsorship — Amber Sherman",   category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 17 },
    { title: "Confirm sponsorship — Selam G.",        category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 18 },
    { title: "Confirm sponsorship — Jennifer Rencones", category: "other", dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 19 },
    { title: "Confirm sponsorship — Dr. Monica Brown",  category: "other", dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 20 },
    { title: "Confirm sponsorship — Lana",            category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 21 },
    { title: "Confirm sponsorship — Isabel O.",       category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 22 },
    { title: "Confirm sponsorship — Brian Nuñez",     category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 23 },
    { title: "Confirm sponsorship — Andres Parra",    category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 24 },
    { title: "Confirm sponsorship — Lorena Quiroz",   category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 25 },
    { title: "Confirm sponsorship — Dr. Robert Robinson", category: "other", dueDate: "2026-08-01", completed: false, assignedTo: null,  notes: null, sortOrder: 26 },
    { title: "Confirm sponsorship — Christian Bello", category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 27 },
    { title: "Confirm sponsorship — Paul Glaze",      category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 28 },
    { title: "Confirm sponsorship — Genny Castillo",  category: "other",    dueDate: "2026-08-01", completed: false, assignedTo: null,     notes: null, sortOrder: 29 },
  ];
